...
b.  Compute the coefficient estimates $\hat{\boldsymbol{\beta}}$ directly from the data.
...
c.  Write the equation of the model for tables in which the payer is a senior citizen. Write the answer in terms of the $\beta$'s.
...
-   7 pts: Complete 5 exercises

-   6 pts: Complete 4 exercises

-   5 pts: Complete 3 exercises

-   4 pts: Complete 2 exercises
