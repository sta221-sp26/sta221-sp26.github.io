...
c.  Show that all eigenvalues of $\mathbf{H}$ are 0 or 1.
...
If the Hessian matrix $\nabla_{\boldsymbol{\beta}}^2 \boldsymbol{\epsilon}^\mathsf{T}\boldsymbol{\epsilon}$ is positive definite, then we know we have found a minimum.
...
a.  Visualize distribution of `weight`. Describe the distribution.
...
a.  Compute $R^2$ for the model in the previous exercise and interpret it in the context of the data.

b.  Compute $RMSE$ for the model from the previous exercise and interpret it in the context of the data.
...
-   I used it for some other debugging task.
-   I pasted the question prompt in and asked for help, but I wrote my answer myself.
-   Other:\_\_\_\_\_\_
