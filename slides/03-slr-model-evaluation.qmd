...
::: appex
📋 [sta221-sp26.github.io/ae/ae-01-model-evaluation.html](https://📋 sta221-sp26.github.io/ae/ae-01-model-evaluation.html  Complete Part 1.)
...
-   Go to the course organization. Click on the repo with the prefix `ae-01`. It contains the starter documents you need to complete the AE.
    ...
    -   If you do not see an `ae-01` repo, use this link to create one: **UPDATE LINK!**
