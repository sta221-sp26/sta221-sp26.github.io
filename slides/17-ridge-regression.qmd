...
:::::: columns
::: {.column width="50%"}
![Image source: Introduction to Statistical Learning](images/countours-ridge.jpg){alt="Image source: Introduction to Statistical Learning" fig-align="center" width="60%"}
:::
...
$$
\hat{\boldsymbol{\beta}}_{ridge} = (\mathbf{X}^\mathsf{T}\mathbf{X} + \lambda\mathbf{I})\mathbf{X}^\mathsf{T}\mathbf{y}
$$
