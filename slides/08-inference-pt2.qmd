...
-   Introduce hypothesis test for $\beta_j$ (time permitting)
...
-   0.780 is the exact relationship between football expenditure and enrollment for these `nrow(football)` institutions in 2019-2020.
...
![Image source: *Introduction to the Practice of Statistics (5th ed)*](images/08/regression.png){fig-align="center" width="80%"}
...
::: callout-note
We will assume these assumptions hold for now and show how to check them after Exam 01.
:::

## Estimating $\sigma^2_{\epsilon}$ {.midi}

-   We have shown how to estimate $\boldsymbol{\beta}$
...
-   Introduced hypothesis test for $\beta_j$ (time permitting)
