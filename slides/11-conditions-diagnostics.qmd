...
![Image source: *Introduction to the Practice of Statistics (5th ed)*](images/08/regression.png){alt="Image source: Introduction to the Practice of Statistics (5th ed)" fig-align="center"}
...
::: question
After fitting a model, we check a set of conditions to evaluate whether these assumptions hold in the data.
:::
...
-   Complete [Lecture 12 prepare](../prepare/prepare-lec12.html)
