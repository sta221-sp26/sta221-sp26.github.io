...
-   Course evaluations - open until April 25 at 11:59pm
...
-   Should receive emails with links to course and TA evaluations.
...
anova(model1, model1_full, test = "Chisq") |> 
  tidy() |>
  kable(digits = 3, col.names = c("term", "df.resid", "deviance", "df", "G", "p.value"))
```
