...
[Written report](#written-report) due Tuesday, April 21 (+ one day grace period)

[Reproducibility + organization](#reproducibility-organization) due Tuesday, April 21 ( + one day grace period)
...
Make sure all code, warnings, and messages are suppressed in the final written report. The final written report is due April 21 at 11:59pm. There is a one-day grace period (no late penalty) for submissions pushed to GitHub by **April 22 at 11:59pm**. This means he report in `written-report.qmd` and the rendered PDF should be pushed to the GitHub repo by **April 22 at 11:59pm**.
:::
